...
type PrintType = "info" | "error" | "log" | "debug" | "warn" | "dir"
...
export class EUtils
{
     ...
     */
    print(type: PrintType,message: string,file=true)
    {
     ...
     */
    RGBA(red: string | number,green: string | number,blue: string | number,alpha: string | number)
    {
